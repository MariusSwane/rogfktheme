#' rogfk
#'
#' A minimal ggplot theme that employs the golden ratio to great effect.
#' Credit to Christopher Adolph (with help from Kai Ping Leung) for Faceting
#' this theme (faculty.washington.edu/cadolph). Tweaked by Marius Swane Wishman.
#'
#' @return Beautifully formatted plot
#'
#' @examples
...
#'   rogfk
#'
#' @importFrom ggplot2 margin theme element_text element_line element_rect
...
rogfk <- theme(
  ...
  # text = element_text(family = "Apercu") # RogFK font, can cause problems
)
# class(rogfk) ## Create this as a class
