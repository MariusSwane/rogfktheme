...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/rogfktheme)](https://CRAN.R-project.org/package=rogfktheme)
[![R CMD Check](https://github.com/MariusSwane/rogfktheme/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/MariusSwane/rogfktheme/actions/workflows/R-CMD-check.yaml)
...
[![Test coverage](https://github.com/MariusSwane/rogfktheme/actions/workflows/test-coverage.yaml/badge.svg)](https://github.com/MariusSwane/rogfktheme/actions/workflows/test-coverage.yaml)
...
[Get started](https://MariusSwane.github.io/rogfktheme/articles/rogfktheme.html)
vignette.
...
`rogfktheme` provides **{{ NUMBER OF VIGNETTES }}** vignettes to learn more about the package:

- the [Get started](https://MariusSwane.github.io/rogfktheme/articles/rogfktheme.html)
...
> Wishman Marius Swane (`r format(Sys.Date(), "%Y")`) rogfktheme: An R 
...
check out our [Contributor Guidelines](https://github.com/MariusSwane/rogfktheme/blob/main/CONTRIBUTING.md).
